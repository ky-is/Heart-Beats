...
public final class Zephyr: NSObject {
	...
	public static func sync(defaults: [String: Any], userDefaults: UserDefaults = UserDefaults.standard) {
		shared.userDefaults = userDefaults
		shared.userDefaults.register(defaults: defaults)
...
extension Zephyr {
	...
	public override func observeValue(forKeyPath keyPath: String?, of object: Any?, change: [NSKeyValueChangeKey: Any]?, context: UnsafeMutableRawPointer?) {
		...
		guard monitoredKeys.contains(keyPath) else {
			return print("Cannot observe unmonitored keyPath", keyPath)
		}
